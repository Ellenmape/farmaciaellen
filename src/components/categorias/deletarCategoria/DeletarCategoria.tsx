    ...
    <>
      <div className='container w-1/3 mx-auto'>
            ...
            <div className='border flex flex-col rounded-2xl overflow-hidden justify-between'>
                ...
                <div className="flex">
                    <button className='text-slate-100 bg-teal-600 hover:bg-indigo-400 w-full py-2' onClick={retornar}>Não</button>
                    <button className='w-full text-slate-100 bg-red-500 hover:bg-indigo-600 flex items-center justify-center' onClick={deletarCategoria}>
                        Sim
                    </button>
                </div>
            </div>
